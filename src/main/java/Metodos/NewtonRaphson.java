...
public class NewtonRaphson extends Base {
    ...
    public double evaluar(Funcion1 funcion, Funcion1 derivada, double x0, double e) {
        return this.evaluar(funcion, derivada, x0, e, 100);
    }

    public double evaluar(Funcion1 funcion, double x0, double e) {
        return this.evaluar(funcion, null, x0, e, 100);
    }

    public double evaluar(Funcion1 funcion, double x0, double e, int n) {
        return this.evaluar(funcion, null, x0, e, n);
    }

    public double evaluar(Funcion1 funcion, Funcion1 derivada, double x0, double e, int n) {
    ...
    public void consola() {
        ...
        Funcion1 funcion = new Funcion1(funcion_cadena);

        if (funcion_derivada.equals("")) {
            this.evaluar(funcion, X0, error, limite);
        } else {
            Funcion1 derivada = new Funcion1(funcion_derivada);
